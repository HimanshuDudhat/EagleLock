...
public class Command {
    ...
    public Command(LockVersion lockVersion) {
        ...
        this.header[0] = 127;
        this.header[1] = 90;
        this.protocol_type = (byte) lockVersion.getProtocolType();
        this.sub_version = (byte) lockVersion.getProtocolVersion();
        this.scene = (byte) lockVersion.getScene();
        this.organization = DigitUtil.shortToByteArray((short) lockVersion.getGroupId());
        this.sub_organization = DigitUtil.shortToByteArray((short) lockVersion.getOrgId());
        this.encrypt = -86;
        this.generateLockType();
    }
